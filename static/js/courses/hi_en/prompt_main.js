...
{//CARD_PROMPT
    ...
    function wcard_prompt_beg() {
        ...
        body.innerHTML = `
            ...
            <div class="container-fluid py-2 m-5">
                
                <div id="cardm" class="row col-12">
                    <div class="row col-sm-12 col-md-6 my-4">
                        <div class="d-flex justify-content-center">
                            <div style="cursor:pointer;"><img class="duo-speaker" src="/static/img/svg/loudspeaker_duo.svg" style="scale:0.7"/></div>
                            <div>
                                <div class="word mb-sm-5">${meaning}
                                    <div class="tooltiptext" onclick="textToSpeech(this.innerText)">${word}</div>
                                </div>
